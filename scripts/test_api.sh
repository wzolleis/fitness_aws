...
serverless webpack invoke --function updatePlan --path mocks/lupdate_plan-event.json
...
serverless webpack invoke --function updateTraining --path mocks/lupdate_training-event.json
