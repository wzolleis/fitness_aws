...
export async function main(event, context, callback) {
    ...
    const params = {
        ...
        // 'ExpressionAnttributeValues' defines the value in the update expression
        ...
        UpdateExpression: 'SET #ex_name = :name, exercises = :exercises, executions = :executions, changedAt = :changedAt, ' +
        ...
        ExpressionAttributeValues: {
            ...
            ':finishedAt': data.finishedAt ? data.finishedAt : undefined
        },
